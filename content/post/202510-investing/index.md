...
- the beginning of the **[COVID19 pandemic](https://en.wikipedia.org/wiki/COVID-19_pandemic)** in 2020
...
{{< figure src="images/dowjones-rolling_revenue_10.svg" title="Rolling yearly revenue after 10 years of investing" attr="" >}}
...
{{< figure src="images/msci-world-rolling_revenue_20.svg" title="Rolling yearly revenue after 20 years of investing into MSCI World Index" attr="" >}}
...
It also makes sense, to not only focus on the financial markets in the developed world, but also on other markets like the **emerging or frontier markets**. This especially makes sense, if we consider the research on [convergence theories](https://en.wikipedia.org/wiki/Convergence_(economics)) e.g. within the Solow-Swan model, where it is assumed, that emerging economies tend to have a higher growth rate. Therefore it is likely, that this economic growth, measured by the gross domestic product, should be reflected by the financial market in the long run.

> #### ⚠️ Caution
> This is not an investment advice.

In the end, we have to pour all these findings in to one financial product an start investing. Me personally, I like to recommend and use the [Vanguard FTSE All-World ETF](https://www.vanguard.co.uk/professional/product/etf/equity/9679/ftse-all-world-ucits-etf-usd-accumulating), because of their cooperative legal structure and their simple way to cover all aspects mentioned earlier in this post. However, any other product following the same principles will do.
